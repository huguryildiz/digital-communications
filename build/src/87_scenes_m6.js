...
const REAL_CODES = realGallery({ id:'m6-real-codes', nav:'Codes around us',
  ...
  notes:[
    ...
    {t:'note', kind:'warn', head:'Fixed length', html:'Braille spends $6$ bits a letter. Without its spaces, the speech in 6.1 carries $4.04$ bits a letter.'}
  ]});
...
{ id:'m6-bsc', module:'M6', nav:'The binary symmetric channel', title:'The binary symmetric channel',
  ...
  {t:'cols', ratio:'c-5-7', fill:true, left:[
    ...
    {t:'reveal', at:2, items:[
      {t:'note', kind:'warn', head:'Hard decisions', html:'Deciding each bit throws away how sure the receiver was. The gallery at the end of 6.5 plots the capacity left after that decision.'}]},
    {t:'reveal', at:3, items:[
...
{ id:'m6-synth', module:'M6', nav:'Summary', title:'Module 6 summary',
  ...
  {t:'reveal', at:1, items:[
    {t:'note', kind:'ok', head:'Method', html:'<span style="color:var(--graphite)">Compress the source to its entropy, then code it for the channel below capacity. The Hamming code of 6.5 is a first such channel code.</span>'}]}
]},
