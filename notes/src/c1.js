...
{t:'toc', items:[
 ['1','The transition from analog to digital','The Fourier transform in $f$. Impulse-train sampling, the spectral replicas and the sampling theorem. The reconstruction filter and the interpolation formula. Uniform quantization, overload, quantization noise and the signal-to-quantization-noise ratio. Dither. Companding. Encoding, line codes, PCM, DPCM and delta modulation. Vector quantization. Speech, audio and image coding.','PS CH7.1&ndash;7.7'],
